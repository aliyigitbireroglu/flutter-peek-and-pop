...
mixin GestureBinding on BindingBase implements HitTestable, HitTestDispatcher, HitTestTarget {
  ...
  void addToPendingPointerEvents(PointerEvent event) => _pendingPointerEvents.add(event);
  ...
  void _handlePointerDataPacket(ui.PointerDataPacket packet) {
    ...
    if (!wasIgnoring) _pendingPointerEvents.addAll(PointerEventConverter.expand(packet.data, window.devicePixelRatio));
    wasIgnoring = false;
  ...
  void _flushPointerEventQueue() {
    ...
    while (_pendingPointerEvents.isNotEmpty) {
      if (!isIgnoring) _handlePointerEvent(_pendingPointerEvents.removeFirst());
    }

    //		assert(!locked);
    //		while (_pendingPointerEvents.isNotEmpty) _handlePointerEvent (
...
class FlutterErrorDetailsForPointerEventDispatcher extends FlutterErrorDetails {
  ...
  const FlutterErrorDetailsForPointerEventDispatcher({
    ...
    bool silent = false,
  }) : super(exception: exception, stack: stack, library: library, context: context, informationCollector: informationCollector, silent: silent);
